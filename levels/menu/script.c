...
const LevelScript level_main_menu_entry_1[] = {
    ...
    LOAD_MODEL_FROM_GEO(MODEL_MAIN_MENU_UP_BUTTON,              geo_menu_up_button),
    LOAD_MODEL_FROM_GEO(MODEL_MAIN_MENU_DOWN_BUTTON,            geo_menu_down_button),
...
const LevelScript level_main_menu_entry_exit[] = {
    EXIT(),
};

const LevelScript level_main_menu_entry_2[] = {
    /*0*/ CALL(/*arg*/ 0, /*func*/ lvl_set_current_level),
    /*2*/ JUMP_IF(/*op*/ OP_EQ, /*arg*/ 0, level_main_menu_entry_exit),
    /*5*/ INIT_LEVEL(),

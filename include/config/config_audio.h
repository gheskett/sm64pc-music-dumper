 ...
 * Vanilla by default only generally allocates 16 or 20 notes at once. Memory usage is typically around 7200 bytes per US/JP note.
 */
#define MAX_SIMULTANEOUS_NOTES 40
